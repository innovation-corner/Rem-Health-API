...
router.post('/child-registration', cors(), (req, res, next) => {
    ImmunizationController.registerChild(req, res, next);
});

router.get('/all-records', cors(), (req, res, next) => {
    ImmunizationController.getAllRecord(req, res, next);
});

router.post('/child-profile', cors(), (req, res, next) => {
    ImmunizationController.getChildProfile(req, res, next);
});

router.post('/search-records', cors(), (req, res, next) => {
